...
const PaymentGateway = ({ paymentInfo }: PaymentGatewayProps) => {
    ...
    <div className="p-6 rounded-lg">
      ...
      <section className='bg-white rounded-xl shadow-lg flex flex-col items-center gap-4 py-10'>
        ...
        <div className='flex items-center gap-0 justify-around'>
          <p className="w-[72%] mx-auto break-words text-lg text-primary text-center">{paymentInfo.address}</p>
        ...
        <div className='flex items-center gap-1.5'>
          ...
          <p className="text-sm font-semibold">{paymentInfo.tag_memo}</p>
        </div>
      </section>
    </div>
  );
